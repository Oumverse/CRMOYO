...
Route::group(['prefix' => '/reports', 'middleware' => ['auth', 'can:report_access']], function () {
    ...
    // Show Report Details
    Route::get('/report', [ReportsController::class, 'show'])->name('reports.show');

    //  more routesfor editing and deleting reports
});
//
//
...
// Compte routes
Route::group(['prefix' => '/comptes', 'middleware' => ['auth']], function () {
    ...
    Route::post('/store', [CompteController::class, 'store'])->name('comptes.store');
    Route::get('/{id}', [CompteController::class, 'show'])->name('comptes.show');
    Route::get('/{id}/edit', [CompteController::class, 'edit'])->name('comptes.edit');
    Route::put('/{id}/update', [CompteController::class, 'update'])->name('comptes.update');
    Route::delete('/{id}', [CompteController::class, 'destroy'])->name('comptes.destroy');
});
